...
@SpringBootTest(classes = {
        ru.practicum.cash.config.KafkaProducerConfig.class,
        ru.practicum.cash.clients.NotificationsClient.class
}, properties = {
...
class NotificationsProducerKafkaTest {
    ...
    @Test
    void sendsCashNotificationEventToKafka() {
        notificationsClient.sendCashEvent("user-2", OperationType.DEPOSIT, new BigDecimal("10.00"), "RUB");
        ...
        assertThat(event.type()).isEqualTo("CASH_DEPOSIT");
        assertThat(event.title()).contains("10.00");
